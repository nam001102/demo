<section class="vh-100 ranking-bg overflow-hidden d-flex align-items-center justify-content-center">
  <div class="glassContainer text-white border-0 shadow-lg mx-auto"
    style="border-radius: 1rem; overflow: hidden; max-width: 400px; height: 500px;">
